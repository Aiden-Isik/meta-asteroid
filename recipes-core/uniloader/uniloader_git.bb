...
do_compile() {
    ...
    oe_runmake ${PARALLEL_MAKE} ARCH="${TARGET_ARCH}" CROSS_COMPILE="${TARGET_PREFIX}" LDFLAGS="" LIBGCC_LOCATE_CFLAGS="--sysroot=${STAGING_DIR_TARGET}" comp-cflagscore="-sysroot=${STAGING_DIR_TARGET}"
}
